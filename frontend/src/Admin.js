...
// Backend da Panificadora Carvalho no Render
const BACKEND_URL = "https://padaria-carvalho-api.onrender.com";
...
// Converte URLs de imagens do backend para URLs completas
  ...
  return (
    <div className="admin-login">
      <div className="admin-login-card">
        ...
        <p>
          Entre com seus dados para gerenciar o cardápio.
        </p>
...
function ProductRow({
  ...
  const dirty =
    JSON.stringify(draft) !== JSON.stringify(p);
    ...
    >
        ...
        <div className="row">
          ...
          <label>
            ...
            <select
              ...
              data-testid={`admin-category-${p.id}`}
            >
              {CATEGORIES.map((c) => (
        ...
        <div className="row">
          <label className="grow">
            ...
            <input
              ...
              data-testid={`admin-description-${p.id}`}
            />
          </label>

          <label className="grow">
            Imagem (URL ou envie foto)
            ...
            <div className="image-input">
              <input
                ...
                data-testid={`admin-image-${p.id}`}
                placeholder="https://... ou envie foto"
              />

              <ImageUploadButton
                testId={`admin-upload-${p.id}`}
                onUploaded={(url) =>
                  setDraft((d) => ({
                    ...d,
                    image_url: url,
      ...
      <div className="admin-product-actions">
        <button
          ...
          onClick={toggle}
          data-testid={`admin-toggle-${p.id}`}
        >
          {p.available ? (
            <>
              <Check size={15} /> Disponível
            </>
          ) : (
            <>
              <XCircle size={15} /> Indisponível
            </>
          )}
        </button>
      ...
      >
        ...
        <label>
          ...
          <input
            ...
            placeholder="Ex.: Sabores disponíveis"
          />
        </label>
  ...
  return (
    <div>
        ...
        <div className="admin-filters">
          {["Todos", ...CATEGORIES].map((c) => (
            <button
              ...
              onClick={() => setFilter(c)}
              data-testid={`admin-filter-${c.toLowerCase()}`}
            >
              {c}
            </button>
          ))}
      ...
      {filter !== "Todos" && (
        ...
        >
          Selecione "Todos" para arrastar e
    ...
    <div>
      ...
      >
        <button
          ...
          data-testid="order-filter-todos"
        >
          Todos
        </button>
      ...
      {visible.length === 0 ? (
        <div
          ...
          data-testid="admin-empty-orders"
        >
        ...
        <div className="admin-orders">
          {visible.map((o) => {
            ...
            return (
              <div
                key={o.order_id}
                className={`admin-order status-${st}`}
                ...
                <div className="admin-order-status-row">
                  ...
                  <label>
                    ...
                    <select
                      ...
                      data-testid={`order-status-select-${o.order_id}`}
                    >
                      {STATUS_LIST.map((s) => (
                        <option
                          key={s}
    ...
    >
      <div className="hours-head">
        ...
        <div>
          ...
          <p>
            Quando a padaria estiver fechada, o
            site vai avisar o cliente e não
      ...
      <header className="admin-topbar">
        <div>
          <Link
            ...
            data-testid="admin-store-link"
          >
            ← Loja
          </Link>

          <b>Painel · Panificadora Carvalho</b>
        </div>
